...
return new class extends Migration
{
    ...
    {
        Schema::create('fm_driver_txn', function (Blueprint $table) {
            ...
            $table->float('driving_rate')->nullable();
            $table->float('trip_distance_km')->nullable();
            $table->float('trip_duration_hrs')->nullable();

            $table->enum('txn_type', ['DEBIT', 'CREDIT', 'NONE'])->default('NONE');
            $table->string('txn_details', 128)->nullable();
            ...
            $table->dateTime('txn_datetime')->nullable();
    ...
    {
        Schema::dropIfExists('fm_driver_txn');
    }
};
