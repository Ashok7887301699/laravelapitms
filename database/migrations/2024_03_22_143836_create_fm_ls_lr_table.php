...
return new class extends Migration
{
   /**
    ...
    {
        Schema::create('fm_ls_lr', function (Blueprint $table) {
            ...
            $table->foreign('thc_id')->references('id')->on('fm_thc')->onDelete('cascade');
            $table->string('ls_id', 24)->nullable();
            $table->foreign('ls_id')->references('id')->on('fm_ls')->onDelete('cascade');
